...
Dans ce document, nous présentons une troisième version du modèle précédent. Dans un premier temps, nous prenons en compte une différence d'albédo en fonction de l'endroit où l'on se trouve sur Terre au lieu de considérer une moyenne sur l'ensemble de la surface terrestre. 
